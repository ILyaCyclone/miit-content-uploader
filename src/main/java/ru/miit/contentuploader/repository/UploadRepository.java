...
public class UploadRepository {
    ...
    public UploadRepository(NamedParameterJdbcTemplate jdbcTemplate, UploaderProperties uploaderProperties) {
    ...
    public LargeBinaryData createLargeBinaryData(long idContentVersion, String filename, InputStream inputStream, int length) {
        // Spring keyHolder can't be used to retrieve generated date
...
//        largeBinaryData.setLastModified((Instant)keyHolder.getKeys().get("d_last"));
    ...
    public LargeBinaryMetadata getLargeBinaryMetadata(long idContentVersion) {
    ...
    public void calculateBlobAttributes(long idContentVersion) {
